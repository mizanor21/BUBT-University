  ...
  return (
    <>
      ...
      <div className="container  p-8 mx-auto max-w-lg">
        ...
        <div className="mb-8">
          <p className="text-lg mb-4">
            ...
            to learn, share, and innovate in the different fields of science and
            technology.
          </p>
          <p className="text-lg">
            The Student Branch has made tremendous efforts in motivating
            students and giving them the right opportunities to lead so they can
            make the most of their talent. This platform will offer a rich
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold mb-4">Constitution</h2>
          <p className="text-lg">
      ...
      <div className="container  p-8 mx-auto max-w-lg">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Article I – Name</h2>
          <p className="mb-4">Section 1: Name</p>
          <p>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Article II – Purpose</h2>
          <p className="mb-4">Section 1: Purpose</p>
          <ul className="list-disc list-inside">
            <li>
              To promote excellence in engineering and the role of engineers in
              developing the quality of life.
            </li>
            <li>
              To encourage professionalism and professional registration among
              power engineering students and engineering staff, and to instill a
              code of engineering ethics in the engineering community.
            </li>
            <li>
            ...
            <li>
              ...
              students by providing a communication link with other students and
              an opportunity to work for common goals.
            </li>
            <li>
            ...
            <li>
              To engage in such other activities as might be consistent with and
              reasonably related to the purposes previously described in this
              Article.
            </li>
          </ul>
          <p className="mb-4">Section 2: Compliance</p>
          <p>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Article III – Membership</h2>
          <p className="mb-4">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Article III – Officers</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            students in Faculty of Engineering &amp; Applied Sciences (FEAS) in
            good standing shall be eligible to hold office. Only one Officer
            position can be held. Honorary Members shall not be entitled to vote
            or to hold office.
          </p>
          <p className="mb-4">
        ...
        <div>
          <h2 className="text-lg font-bold mb-4">Article IV – Executive</h2>
          <p className="mb-4">
            Section 1: The management of the affairs of the Branch shall be in
            the hands of the Executive, consisting of the Officers of the Branch
            and the Branch Counselor, who is appointed by the IEEE. The Branch
            Chair shall also chair the Executive.
          </p>
          <p className="mb-4">
            ...
            filling of vacancies in offices, authorization of expenditure, etc.
          </p>
          <p className="mb-4">
      ...
      <div className="container  p-8 mx-auto max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article V – Duties of Officers</h1>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Chairperson:</h2>
          <ul className="list-disc list-inside">
            <li>
            ...
            <li>
              Certify that officers are meeting or exceeding goals set forth for
              each semester.
            </li>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Vice-Chairperson:</h2>
          <ul className="list-disc list-inside">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Secretary:</h2>
          <ul className="list-disc list-inside">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Treasurer:</h2>
          <ul className="list-disc list-inside">
            <li>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Event Coordinator:</h2>
          <ul className="list-disc list-inside">
            <li>
              Set up bi-weekly meetings and look into IEEE events held
              throughout surrounding communities.
            </li>
            <li>Coordinate and organize social events for the organization.</li>
          </ul>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Social Media Coordinator:</h2>
          <ul className="list-disc list-inside">
            <li>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Webmaster:</h2>
          <ul className="list-disc list-inside">
            <li>
              Administer all of the organization's internet platforms (website,
      ...
      <div className="container  p-8 mx-auto max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article VI – Activities</h1>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Section 1: Planning</h2>
          <p>
            ...
            times, dates of activities, and the schedule of related events. This
            schedule shall be dictated primarily by the Branch Leadership with
            the review of Branch Counsellor.
          </p>
        </div>
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <p>
            ...
            material. General meetings seek to recruit new members of the Branch
            while offering insight on Branch developments and its related
            fields. Exemptions of general meetings may occur during university
            holidays and breaks. General meetings are open to the public.
          </p>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">
          ...
          <p>
            ...
            These activities may include company tours, regional events, Branch
            conferences, and developments in research/skills of the Branch.
          </p>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article VI – Amendments</h1>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">
          ...
          <p>
            ...
            submitted to Branch Officers for review. If deemed appropriate, the
            Branch Officers will then subject the potential amendments for
            review by the Branch Membership. After a two-thirds vote in favor of
            the amendment, the amendment will be reviewed once more by the
            Branch Officers who will then decide with their own vote. If a
            two-thirds vote in favor of the amendment by the Branch Officers is
            found, then the amendment will officially be joined to this
            Constitution.
          </p>
          <p>
            If the potential amendments fail either by the vote from the
            Membership or by the vote from the Officers, it will be shelved for
            the duration of two weeks in which a Member, be that an Officer or
            not, of the Chapter may submit it for review of the Branch Officers
            to begin the process once more. Upon failing either vote a
            subsequent time, the potential amendments will be shelved for the
            duration of one year in which only an Officer may bring it up for
            vote once more until the period of one year has passed.
          </p>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article VII – Bylaws</h1>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">
          ...
          <p>
            ...
            will be called the "Bylaws." These will provide further explanation
            of the internal rules and regulations as referred to in the
            Constitution.
          </p>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">Section 2: Modification</h2>
          <p>
            ...
            discussed at the official meetings and after a successful vote will
            be taken into effect immediately.
          </p>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article VIII – Dissolution</h1>
        </div>
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article IX – Finances</h1>
        </div>
        <p>
          ...
          bank. All funds will be stored in this bank account. The names on the
          bank account will be the Chairperson’s, the Treasurer’s, and the
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold">Article X– Ratification</h1>
        </div>
        <p>
